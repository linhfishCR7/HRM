    ...
    <div class="list-group">
        ...
        <div class="list-group-item document">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="gv_PhieuTraLuong" runat="server" CssClass="table table-bordered table-responsive" AutoGenerateColumns="False" DataSourceID="SqlDataSource1_TienLuong" Width="100%" DataKeyNames="MaLuong">
                        <Columns>
